...
import com.thymeleaf.demo.service.PessoaService;
...
public class PessoaWebController {
    ...
    @GetMapping("/{id}")
    public String detalhesPessoa(@PathVariable Integer id, Model model) {
    ...
    public String excluirPessoa(@PathVariable Integer id, RedirectAttributes ra) {
